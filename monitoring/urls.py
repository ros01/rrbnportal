...
urlpatterns = [
    ...
    path('<uuid:pk>/license_detail/', LicenseDetailView.as_view(), name='license_detail'),
    path('<uuid:id>/practice_permit_renewal_details/', PermitRenewalDetails.as_view(), name='practice_permit_renewal_details'),
    path('<uuid:pk>/accreditation_detail/', AccreditationDetailView.as_view(), name='accreditation_detail'),
