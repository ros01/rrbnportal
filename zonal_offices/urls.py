...
from .views import (
    ...
    InspectionReportsRejectionsView,
    ...
    AccreditationReportUpdateView,
    InspectionReportUpdateView,
...
urlpatterns = [
    ...
    path('<uuid:pk>/inspection_detail/', InspectionView.as_view(), name='inspection_detail'),
    ...
    path('<uuid:id>/accreditation-report/edit/', AccreditationReportUpdateView.as_view(), name='accreditation_report_update'),
    path('<uuid:pk>/inspection-report/edit/', InspectionReportUpdateView.as_view(), name='inspection_report_update'),
    ...
    path('inspection_reports_rejections_list/', InspectionReportsRejectionsView.as_view(), name='inspection_reports_rejections_list'),
    ...
    path('<uuid:pk>/fluoroscopy_score/', FluoroscopyScore.as_view(), name='fluoroscopy_score'),
    path('<uuid:id>/fluoroscopy_update/', FluoroscopyScoreUpdate.as_view(), name='fluoroscopy_update'),
