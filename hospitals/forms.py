...
class HospitalUpdateModelForm(forms.ModelForm):
    class Meta:
        model = Document
        fields = ('hospital_name', 'hospital_type', 'facility_address', 'facility_state_of_location', 'equipment', 'radiographer_in_charge', 'radiographer1', 'radiographer2', 'radiographer3', 'radiographer_in_charge_license_no', 'radiographer1_license_no', 'radiographer2_license_no', 'radiographer3_license_no', 'staffname1', 'staffname2', 'staffname3', 'staffname4', 'staffname5', 'staffdesignation1', 'staffdesignation2', 'staffdesignation3', 'staffdesignation4', 'staffdesignation5', 'radiographer_in_charge_passport', 'radiographer_in_charge_nysc', 'radiographer_in_charge_practice_license', 'radiographer1_practice_license', 'radiographer2_practice_license', 'radiographer3_practice_license', 'cac_certificate', 'form_c07')
    ...
    def __init__(self, *args, **kwargs):
       ...
       super(HospitalUpdateModelForm, self).__init__(*args, **kwargs)
       for name in self.fields.keys():
            self.fields[name].widget.attrs.update({
                'class': 'form-control',
            })
