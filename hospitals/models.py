...
class Document(models.Model):
    ...
    radiographer2_practice_license = models.FileField(upload_to='%Y/%m/%d/', blank=True)
    radiographer3_practice_license = models.FileField(upload_to='%Y/%m/%d/', blank=True)
    cac_certificate = models.FileField(upload_to='%Y/%m/%d/', blank=True)
    form_c07 = models.FileField(upload_to='%Y/%m/%d/', blank=True)
