...
class Inspection(models.Model):
    ...
    equipment_layout = models.IntegerField()
    radiographer_no = models.IntegerField()
    radiologist_certification = models.IntegerField()
    radiographer_license = models.IntegerField()
    personnel_monitoring = models.IntegerField()
    room_adequacy = models.IntegerField()
    water_supply = models.IntegerField()
    equipment_certification = models.IntegerField()
    accessories = models.IntegerField()
    warning_light = models.IntegerField()
    C07_form_compliance = models.IntegerField()
    functional_equipment = models.IntegerField()
    equipment_installation = models.IntegerField()
