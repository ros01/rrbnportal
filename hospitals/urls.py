...
from .views import (
    ...
    AccreditationVerificationsCompleted,
    ScheduleListView,
    ScheduleDetailView,
    InspectionListView,
    InspectionView,
...
urlpatterns = [
    ...
    path('<uuid:pk>/update_internship_application/', UpdateIntApplication.as_view(), name='update_internship_application'),
    ...
    path('<uuid:pk>/start_new_pri_internship_renewal/', StartNewPriInternshipRenewal.as_view(), name='start_new_pri_internship_renewal'),
    ...
    path('<uuid:pk>/verifications_completed/', VerificationsCompleted.as_view(), name='verifications_completed'),
    path('<uuid:pk>/accreditation_verifications_completed/', AccreditationVerificationsCompleted.as_view(), name='accreditation_verifications_completed'),
