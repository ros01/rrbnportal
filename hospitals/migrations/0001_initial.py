    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vet_date', models.DateField(default=datetime.date.today)),
        ...
        migrations.AddField(
            ...
            name='payment',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='payment_2', to='hospitals.Payment'),
        ),
        migrations.AddField(
            model_name='inspection',
            name='schedule',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='schedule_2', to='hospitals.Schedule'),
        ),
        migrations.CreateModel(
            name='Appraisal',
            fields=[
                ...
                ('photo_5', models.ImageField(blank=True, upload_to='%Y/%m/%d/')),
                ('photo_6', models.ImageField(blank=True, upload_to='%Y/%m/%d/')),
                ('practice_manager', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Xray',
